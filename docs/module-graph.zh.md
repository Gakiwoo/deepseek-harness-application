...
flowchart TD
  ...
  subgraph group_host["packages/host"]
    ...
    pkg_host_terminal_manager["host-terminal-manager"]
  ...
  pkg_host_plugin_manager --> pkg_invariants
  pkg_host_terminal_manager --> pkg_invariants
  ...
  pkg_api_remotes --> pkg_host_plugin_manager
  pkg_api_remotes --> pkg_host_terminal_manager
...
| [`host-plugin-manager`](../packages/host/plugin-manager) | `host` | [`invariants`](../packages/runtime-diagnostics/invariants) |
| [`host-terminal-manager`](../packages/host/terminal-manager) | `host` | [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`api-remotes`](../packages/api/remotes) | `api` | [`agent`](../packages/core/agent), [`agent-presets`](../packages/preset/agent-presets), [`api-gateway`](../packages/api/gateway), [`commands`](../packages/interaction/commands), [`cordis-host-runner`](../packages/extensions/cordis-host-runner), [`credentials`](../packages/credentials/credentials), [`goal`](../packages/goal/goal), [`host-plugin-inventory`](../packages/host/plugin-inventory), [`host-plugin-manager`](../packages/host/plugin-manager), [`host-terminal-manager`](../packages/host/terminal-manager), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`message-feedback`](../packages/feedback/message-feedback), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`settings`](../packages/settings/settings), [`typert-registry`](../packages/typert/registry) |
