...
This guide assumes you started the Web UI through the CLI's [Web alias](../../../apps/cli/reference/README.md#web-alias). Model changes take effect on the next request without restarting the server.
