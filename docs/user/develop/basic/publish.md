...
To use a fresh source checkout instead, complete the [source-execution section](../../../../apps/cli/reference/README.md#source-execution), keep this tutorial's `hello-plugin` directory at the repository root, and run the remaining `dsh ...` commands from there as `pnpm dsh ...`. See [source execution](../../../../apps/cli/reference/README.md#source-execution) for build and launcher behavior.
