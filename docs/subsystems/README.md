...
| [desktop-app.md](desktop-app.md) | the desktop surface bundle: `ctx.desktopRuntime` (`DesktopRuntime`), the IPC fetch carrier, the `dsh://` frontend, and the `app:desktop-surface` prompt section |
