...
const MULTI_PROCESS_TEST_TIMEOUT_MS = 40_000
...
async function waitForPath(path: string): Promise<void> {
  // The installer and its forked child contend for the lock under suite-wide
  // fork load; a 5s deadline is too tight on shared CI/sandbox hardware.
