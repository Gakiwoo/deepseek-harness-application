...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/host/plugin-manager': { kind: 'none', reason: 'Host-side profile plugin mutation; runs pnpm and registers nothing model-facing.' },
  'packages/host/terminal-manager': { kind: 'none', reason: 'Host-side user-owned terminal sessions; streams shell text and registers nothing model-facing.' },
