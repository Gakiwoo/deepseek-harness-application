...
describe('synchronous cleanup on host exit', () => {
  ...
  ])('removes an ordinary managed tree after $trigger', { timeout: 75_000 }, async ({
    trigger,
    expectedCode,
    diagnostic,
  }) => {
  ...
  it('preserves normal terminate-and-join disposal and removes the exit listener', { timeout: 75_000 }, async () => {
