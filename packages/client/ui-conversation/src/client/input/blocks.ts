...
import type { ComposerBlock, ComposerBlocks } from '../contract/input-types.ts'

// Re-export the shared composer-block types for this domain's consumers
// (apply.ts and service.ts import them from './blocks.ts').
export type { ComposerBlock, ComposerBlocks } from '../contract/input-types.ts'
