/**
 * Session-domain shared contract types: the data shapes the `ISessions`
 * service face (and presentation consumers) reference. Lifted out of the
 * sessions implementation so the contract layer never imports a domain.
 */
import type {
...
/** Session-list arrival lifecycle exported as the standard feed's `phase` axis. */
...
/** Session-list row facts plus the current selection, projected for UI consumers. */
