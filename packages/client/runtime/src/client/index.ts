...
import type { SessionListState } from './contract/session-types.ts'
...
} from './contract/session-types.ts'
export type { SessionListPhase, SessionSearchResultItem, SubagentCatalogSnapshot } from './contract/session-types.ts'
export type { SubagentAddress, JobView } from '@deepseek-ai/dsh-client-connection/client'
export type { WorkspaceListPhase, WorkspaceListState } from './contract/workspace-types.ts'
export type {
...
} from './contract/conversation-snapshot.ts'
export {
...
export { contextForm, contextProvenance } from './contract/context-provenance.ts'
...
export type {
  PendingInteraction, PendingKind, PendingPayloads,
} from './contract/pending.ts'
export type { PendingInteractionStatus } from './contract/session-types.ts'
...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  ...
  interface GlobalStandardProps {
    ...
    useWorkspaces: SnapshotSelectorHook<import('./contract/workspace-types.ts').WorkspaceListState>
  }
}
