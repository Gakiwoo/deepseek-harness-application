 ...
 * face). The webServer half (route + index injection) is a lazy injection: a
 * surface without webServer (the desktop shell) consumes the same composed
 * graph through `graph()`/`clientPath()` directly.
 *
