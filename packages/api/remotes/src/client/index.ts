...
import terminalManagerRemote from '@deepseek-ai/dsh-host-terminal-manager/remote'
import messageFeedbackRemote from '@deepseek-ai/dsh-message-feedback/remote'
import type { TypertClientRemote } from '@deepseek-ai/dsh-typert-protocol'

export type { TypertClientRemote as ClientRemote } from '@deepseek-ai/dsh-typert-protocol'
export type { PluginInventorySnapshot } from '@deepseek-ai/dsh-host-plugin-inventory/types'
export type { PluginMutationResult } from '@deepseek-ai/dsh-host-plugin-manager/types'
export type { TerminalReadResult, TerminalSpawnResult } from '@deepseek-ai/dsh-host-terminal-manager/types'
export type {} from '@deepseek-ai/dsh-commands/remote'
export type {} from '@deepseek-ai/dsh-goal/remote'
export type {} from '@deepseek-ai/dsh-host-plugin-inventory/remote'
export type {} from '@deepseek-ai/dsh-host-plugin-manager/remote'
export type {} from '@deepseek-ai/dsh-host-terminal-manager/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, pluginManagerRemote, terminalManagerRemote,
